...
- Depuis janvier 2020 une nouvelle sources :
  - Les [**données de caisse**]{.orange} :  $\approx 1,7$ milliards d'enregistrements par mois 
...
- Production d'indices de prix plus proche du [**ressenti des ménages**]{.orange}
...
- [**Objectif**]{.orange} : améliorer l'indice des prix dans le secteur de l'[**hotellerie**]{.blue2}
...
- Indice des prix du [**transport en train**]{.orange} : webscrapping de la [SNCF]{.blue2}
...
- Comparaison de méthodes [**macroéconomiques traditionnelles**]{.orange} (ARIMA, modèles à facteurs dynamiques) et [**méthodes d'apprentissage automatique**]{.orange} (Lasso, forêts aléatoires) 

## Pour quels résultats ?

![](img/rmsfe_pib.png){fig-align="center"}

- Prévisions proches mais [**volatilité des modèles diffèrent**]{.orange}
...
- Données fournits par un [**unique opérateur**]{.orange} : [Orange](https://www.orange.fr)
...
1. [**Ne plus dépendre d'un seul opérateur**]{.orange} : biais statistique ?
...
3. [**Approfondir la méthodologie**]{.orange} :
...
- Détecter les [**apparitions/disparistions d'habitations**]{.orange}
...
- Données Carte bancaire CB recouvre[**82% des opérations**]{.orange}
