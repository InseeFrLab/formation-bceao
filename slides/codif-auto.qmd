...
{{< include codif-auto-sections/1-Context.qmd >}}

# Méthodologie

{{< include codif-auto-sections/2-Methodo.qmd >}}

# Résultats

{{< include codif-auto-sections/3-Results.qmd >}}

# De l'expérimentation à la mise en production

{{< include codif-auto-sections/4-Deployment.qmd >}}
