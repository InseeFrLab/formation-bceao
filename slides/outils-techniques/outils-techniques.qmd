---
title: 'Besoins techniques pour la big data : infrastructures, logiciels et organisation'
subtitle: |
  **[BCEAO - Jour 2]{.orange}**
...
- Fournir des [**ressources**]{.orange} adaptées aux [**nouveaux usages**]{.orange}
  ...
  - [**Parallélisation**]{.blue2} / [**Calcul distribué**]{.blue2}
  - Entraînement de modèles de [**machine learning**]{.blue2} sur [**GPUs**]{.blue2}
