...
- Des sources et des sujets variés qui impliquent de [**nombreuses dimensions**]{.orange} (juridique, technique, méthodologique, organisationnelle, ...)

- Le [**statisticien public**]{.orange} ne peut incarner tous ces aspects

- Développer des [**synergies**]{.orange} entre toutes les parties prenantes (directions métiers, informatique, partenaires, ...)
