...
Le Cloud offre de nombreux avantages, notamment la possibilité de manipuler des données sans avoir à les stocker localement, ainsi qu'une puissance de calcul accrue.
...
C'est plus long à run, mais c'est normal ? comment expliquer ? flux intra cluster ? @romain
