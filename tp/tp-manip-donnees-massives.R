...
############################################################
# Manipulation des données parquet en mode "Lazy"
############################################################
...
# Une fois la requête créée, il existe deux méthodes pour réaliser le calcul.
# La première est la fonction collect()

t <- Sys.time()


# la seconde est la méthode compute()
